...
class LoseScene extends Phaser.Scene {
    ...
    preload() {
      ...
      this.load.audio('loseTheme', [
          'https://content.codecademy.com/courses/learn-phaser/fastfoodie/audio/music/4-loseTheme.ogg',
          'https://content.codecademy.com/courses/learn-phaser/fastfoodie/audio/music/4-loseTheme.mp3'
    ...
    create() {
      ...
      // Insert Score
      this.add.text(gameState.cam.midPoint.x, gameState.cam.midPoint.y - 300, 'Score: ' + gameState.score, { fontSize: '72px', fill: '#ffffff' }).setOrigin(0.5);
